...
namespace WalletService.Controllers
{
    ...
    public class loginControlle : ControllerBase
    {
        ...
        public loginControlle(IMapper mapper, ICacheService cacheService, IUserService userService, IAuditTrailLogService auditTrailLogService, ILoginService loginService)
        {
            _mapper = mapper;
